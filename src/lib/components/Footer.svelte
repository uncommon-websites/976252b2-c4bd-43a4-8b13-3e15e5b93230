	...
	<div class="max-w-7xl mx-auto">
		<div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-16">
			<div class="col-span-2 lg:col-span-1">
				<a href="/" class="flex items-center gap-3 text-brand-dark font-medium text-xl tracking-tight mb-6">
			...
			<div>
				...
				<ul class="space-y-3">
					<li><a href="#" class="text-xs font-mono text-gray-600 hover:text-brand-green transition-colors">AlphaCode vs Pulumi</a></li>
					<li><a href="#" class="text-xs font-mono text-gray-600 hover:text-brand-green transition-colors">AlphaCode vs Terraform</a></li>
					<li><a href="#" class="text-xs font-mono text-gray-600 hover:text-brand-green transition-colors">DevOps Automation Guide</a></li>
					<li><a href="#" class="text-xs font-mono text-gray-600 hover:text-brand-green transition-colors">Infrastructure as Code Best Practices</a></li>
					<li><a href="#" class="text-xs font-mono text-gray-600 hover:text-brand-green transition-colors">Benchmarks</a></li>
					<li><a href="#" class="text-xs font-mono text-gray-600 hover:text-brand-green transition-colors">Knowledge Base</a></li>
				</ul>
			</div>
		</div>
